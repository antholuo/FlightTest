...
{
    {PWM1_Pin, PWM1_GPIO_Port, &htim1, TIM_CHANNEL_1, false, {0}, 0, 0},
    {PWM2_Pin, PWM2_GPIO_Port, &htim1, TIM_CHANNEL_2, false, {0}, 0, 0},
    {PWM3_Pin, PWM3_GPIO_Port, &htim1, TIM_CHANNEL_3, false, {0}, 0, 0},
    {PWM4_Pin, PWM4_GPIO_Port, &htim1, TIM_CHANNEL_4, false, {0}, 0, 0},
	{PWM5_Pin, PWM5_GPIO_Port, &htim3, TIM_CHANNEL_1, false, {0}, 0, 0},
	{PWM6_Pin, PWM6_GPIO_Port, &htim3, TIM_CHANNEL_2, false, {0}, 0, 0},
	{PWM7_Pin, PWM7_GPIO_Port, &htim3, TIM_CHANNEL_3, false, {0}, 0, 0},
	{PWM8_Pin, PWM8_GPIO_Port, &htim3, TIM_CHANNEL_4, false, {0}, 0, 0}
};
